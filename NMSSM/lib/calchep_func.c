...
double ewsbNMSSM(double tb, double MG1, double MG2, double MG3, double Ml2,
                 double Ml3, double Mr2, double Mr3, double Mq2, double Mq3,
                 double Mu2, double Mu3, double Md2, double Md3, double At,
                 double Ab, double Al, double mu, double LambdQ, double KappaQ,
                 double aLmbdQ, double aKappQ, double mXiF, double mXiS,
                 double muP, double msP, double m3h) {
  int prec = 2;
  if (mXiF || mXiS || muP || msP || m3h)
    prec = 0;
  ...
  fprintf(f,
          ...
          prec);
  //   fprintf(f," 1   %.8E       # alpha_em^(-1)(MZ) SM
  //   MSbar\n",1/findValW("alfEMZ")); fprintf(f," 2   %.8E       # G_Fermi
  //   \n",1.16637E-5);
