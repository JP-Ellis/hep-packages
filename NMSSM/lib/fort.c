...
int nmssmsugra_(double *m0, double *mhf, double *a0, double *tb, double *sgn,
                double *Lambda, double *aLambda, double *aKappa, double *xif,
                double *xis, double *muP, double *MSPQ, double *M3HQ) {
  return nmssmSUGRA(*m0, *mhf, *a0, *tb, *sgn, *Lambda, *aLambda, *aKappa, *xif,
                    *xis, *muP, *MSPQ, *M3HQ);
}
