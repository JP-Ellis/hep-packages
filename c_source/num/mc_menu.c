...
//           strcpy(title,"Incoming particle distribution");
           ...
           if(on[0]&&on[1]) plot_N("Partice structure functions",xName,z1,z2, LOG,title, 2, 
                              p_name[0], nPoints, f[0], NULL,
                              p_name[1], nPoints, f[1], NULL);
           else 
           { if(on[0]) l=0; else l=1;
              plot_N("Particle structure function",xName, z1,z2, LOG,title,1,p_name[l], nPoints, f[l],NULL);   
           }  
           put_text(&screen);
...
L1:
   ...
   { case 0:  return 0;
     ...
     case 3:  *gswidth_int =! *gswidth_int; break;
   }    
    goto L1;
} /* w_men__ */
