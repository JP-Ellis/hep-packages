...
double calcspectrum_(int *key, double *Sg, double *Se, double *Sp, double *Sne,
                     double *Snm, double *Snl, int *err, int len) {
  double *Sg_ = NULL, *Se_ = NULL, *Sp_ = NULL, *Sne_ = NULL, *Snm_ = NULL,
         *Snl_ = NULL;
  ...
  if (Sp != mocommon_.par)
    Sp_ = Sp;
  if (Sne != mocommon_.par)
    Sne_ = Sne;
  if (Snm != mocommon_.par)
    Snm_ = Snm;
  if (Snl != mocommon_.par)
    Snl_ = Snl;
...
void gammafluxtab_(double *fi, double *dfi, double *sigmaV, double *Sp,
                   double *Sobs) {
...
extern void solarmodulation_(double *PHI, double *mass, double *inTab,
                             double *outTab) {
...
int basicnuspectra_(int *forSun, double *Mass, int *pdgN, int *pol, double *nu,
                    double *nuB) {
