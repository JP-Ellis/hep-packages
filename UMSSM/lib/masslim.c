...
int masslimits_(void) {
  ...
  int limCharg = 0, limSne = 0, limSnm = 0, limSnl = 0, limSeR = 0, limSmR = 0,
      limSl1 = 0, limSb1 = 0, limSt1 = 0, limSq = 0;
  ...
  if (limSne) {
    retcode += 2;
    printf("WARNING: Sneutrino-e_L below LEP limit \n");
  }
  if (limSnm) {
    retcode += 4;
    printf("WARNING: Sneutrino-mu_L below LEP limit \n");
  }
  if (limSnl) {
    retcode += 8;
    printf("WARNING: Sneutrino-tau_L below LEP limit \n");
  }
  if (limSeR) {
    retcode += 16;
