...
int defined_em_charge(void) { return ph_f; }
...
static void set_sc_ch(Term a2, Atom p1, Atom p2, int php) {
  ...
  while (!is_empty_list(l)) {
    ...
    if (ListLength(sp) == 1 && (cn = ListFirst(sp)) &&
        CompoundName(cn) == A_MOMENT && CompoundArg1(cn) == mprt &&
        ListFirst(CompoundArg2(cn)) == mind) {
  ...
  while (!is_empty_list(l)) {
    ...
    if (ListLength(sp) == 2 && (cn = ListFirst(sp)) &&
        (CompoundName(cn) == A_MOMENT ||
         ((cn = ListNth(sp, 2)) && CompoundName(cn) == A_MOMENT)) &&
...
static int get_num(void) { return c_num; }
  ...
  while (!is_empty_list(l1)) {
    ...
    if (ListLength(l2) == 3) {
      ...
      if (CompoundArg1(ListFirst(l2)) == ph_f) {
        ...
        p2 = ListNth(l2, 3);
        php = 1;
      } else if (CompoundArg1(ListNth(l2, 2)) == ph_f) {
        p1 = ListNth(l2, 1);
        p2 = ListNth(l2, 3);
        php = 2;
      } else if (CompoundArg1(ListNth(l2, 3)) == ph_f) {
        p1 = ListNth(l2, 1);
        p2 = ListNth(l2, 2);
        php = 3;
      } else {
