  ...
  for (l1 = ml; l1; l1 = ListTail(l1)) {
    ...
    for (l2 = lp; l2 && ListTail(l2); l2 = ListTail(l2))
      for (l3 = ListTail(l2); l3; l3 = ListTail(l3)) {
        ...
        if ((prm1 == sapb2 && prm2 == capb2) ||
            (prm1 == capb2 && prm2 == sapb2)) {
          lp = ConsumeCompoundArg(m1, 2);
          ChangeList(l1, 0);
          ml = CutFromList(ml, l1);
        ...
        if ((prm1 == samb2 && prm2 == camb2) ||
            (prm1 == camb2 && prm2 == samb2)) {
          lp = ConsumeCompoundArg(m1, 2);
          ChangeList(l1, 0);
          ml = CutFromList(ml, l1);
  ...
  for (l1 = ml; l1; l1 = ListTail(l1)) {
    ...
    for (l2 = lp; l2 && ListTail(l2); l2 = ListTail(l2))
      for (l3 = ListTail(l2); l3; l3 = ListTail(l3)) {
        ...
        if ((prm1 == capb2 && prm2 == camb2) ||
            (prm1 == camb2 && prm2 == capb2) ||
            (prm1 == sapb2 && prm2 == samb2) ||
            (prm1 == samb2 && prm2 == sapb2)) {
          lp = ConsumeCompoundArg(m1, 2);
          ChangeList(l1, 0);
          ml = CutFromList(ml, l1);
        ...
        if ((prm1 == sapb2 && prm2 == camb2) ||
            (prm1 == camb2 && prm2 == sapb2) ||
            (prm1 == samb2 && prm2 == capb2) ||
            (prm1 == capb2 && prm2 == samb2)) {
          lp = ConsumeCompoundArg(m1, 2);
          ChangeList(l1, 0);
          ml = CutFromList(ml, l1);
...
int tri_heu_2(Term v2d, List ml, List *l_l, List *l_r) {
  ...
  if (p) {
    csf = AppendLast(csf,
                     MakeCompound2(OPR_POW, CompoundArg1(CompoundArgN(v2d, 4)),
                                   NewInteger(p)));
    if (sapb_s == -1 && (p % 2) == 1)
      csf_s = -csf_s;
  }
  ...
  if (p) {
    csf = AppendLast(csf,
                     MakeCompound2(OPR_POW, CompoundArg1(CompoundArgN(v2d, 6)),
                                   NewInteger(p)));
    if (capb_s == -1 && (p % 2) == 1)
      csf_s = -csf_s;
  }
  ...
  if (p) {
    csf = AppendLast(csf,
                     MakeCompound2(OPR_POW, CompoundArg1(CompoundArgN(v2d, 5)),
                                   NewInteger(p)));
    if (samb_s == -1 && (p % 2) == 1)
      csf_s = -csf_s;
  }
  ...
  if (p) {
    csf = AppendLast(csf,
                     MakeCompound2(OPR_POW, CompoundArg1(CompoundArgN(v2d, 7)),
                                   NewInteger(p)));
    if (camb_s == -1 && (p % 2) == 1)
      csf_s = -csf_s;
  }
    ...
    for (l2 = CompoundArg2(ListFirst(l1)); l2; l2 = ListTail(l2)) {
      ...
      if (is_atom(CompoundArg1(ListFirst(l2))) &&
        ...
        SetCompoundArg(ListFirst(l2), 1,
                       CopyTerm(GetAtomProperty(CompoundArg1(ListFirst(l2)),
                                                A_DUMMY_PRM)));
      }
      ...
      if (CompoundArg1(ListFirst(l2)) == sapb1) {
        ...
        SetCompoundArg(m1, 2,
                       MakeList2(MakeCompound2(OPR_POW, sa1, NewInteger(1)),
                                 MakeCompound2(OPR_POW, ca2, NewInteger(1))));

        m2 = MakeCompound(A_MTERM, 3);
        SetCompoundArg(m2, 1, NewInteger(sapb_s));
        SetCompoundArg(m2, 2,
                       MakeList2(MakeCompound2(OPR_POW, ca1, NewInteger(1)),
      ...
      if (CompoundArg1(ListFirst(l2)) == c2a1) {
        ...
        SetCompoundArg(m1, 2,
                       MakeList1(MakeCompound2(OPR_POW, ca1, NewInteger(2))));

        m2 = MakeCompound(A_MTERM, 3);
        SetCompoundArg(m2, 1, NewInteger(-c2a1_s));
        SetCompoundArg(m2, 2,
                       MakeList1(MakeCompound2(OPR_POW, sa1, NewInteger(2))));
        if (c2a1_s == 1)
          SetCompoundArg(ListFirst(l2), 1, MakeList2(m1, m2));
        else
          SetCompoundArg(ListFirst(l2), 1, MakeList2(m2, m1));
      ...
      if (CompoundArg1(ListFirst(l2)) == s2a2) {
        ...
        SetCompoundArg(m1, 1, NewInteger(2));
        SetCompoundArg(m1, 2,
                       MakeList2(MakeCompound2(OPR_POW, sa2, NewInteger(1)),
                                 MakeCompound2(OPR_POW, ca2, NewInteger(1))));
      ...
      if (CompoundArg1(ListFirst(l2)) == c2a2) {
        ...
        SetCompoundArg(m1, 2,
                       MakeList1(MakeCompound2(OPR_POW, ca2, NewInteger(2))));

        m2 = MakeCompound(A_MTERM, 3);
        SetCompoundArg(m2, 1, NewInteger(-c2a2_s));
        SetCompoundArg(m2, 2,
                       MakeList1(MakeCompound2(OPR_POW, sa2, NewInteger(2))));
        if (c2a2_s == 1)
          SetCompoundArg(ListFirst(l2), 1, MakeList2(m1, m2));
        else
          SetCompoundArg(ListFirst(l2), 1, MakeList2(m2, m1));
      ...
      if (CompoundArg1(ListFirst(l2)) == s2a3) {
        ...
        SetCompoundArg(m1, 1, NewInteger(2));
        SetCompoundArg(m1, 2,
                       MakeList2(MakeCompound2(OPR_POW, sa3, NewInteger(1)),
      ...
      if (CompoundArg1(ListFirst(l2)) == c2a3) {
        ...
        SetCompoundArg(m1, 2,
                       MakeList1(MakeCompound2(OPR_POW, ca3, NewInteger(2))));

        m2 = MakeCompound(A_MTERM, 3);
        SetCompoundArg(m2, 1, NewInteger(-c2a3_s));
        SetCompoundArg(m2, 2,
                       MakeList1(MakeCompound2(OPR_POW, sa3, NewInteger(2))));
        if (c2a3_s == 1)
          SetCompoundArg(ListFirst(l2), 1, MakeList2(m1, m2));
        else
          SetCompoundArg(ListFirst(l2), 1, MakeList2(m2, m1));
