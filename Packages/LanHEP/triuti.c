...
int tri_divf(Term a1, List *l_1, List *l_2, List ml) {
  ...
  for (l1 = f_l; l1; l1 = ListTail(l1)) {
    ...
    SetCompoundArg(
        m2, 1, NewInteger(IntegerValue(CompoundArgN(ListFirst(l1), 4)) / 128));
...
static int tri_rep_d(List *ml, int s1, Atom i1, int s2, Atom i2, Atom o1,
                     Atom o2) {
  List l1, l2;
...
static int tri_rep_e(List *ml, int s1, Atom i11, Atom i12, int s2, Atom i21,
                     Atom i22, Atom o) {
  List l1, l2, l3;
...
static int tri_rep_f(List *ml, Atom sp, Atom sm, Atom cp, Atom cm, int sn1,
                     int sn2, int has1, Atom o) {
  ...
  for (l1 = *ml; l1; l1 = ListTail(l1)) {
    ...
    if (is_empty_list(k1) || is_empty_list(k2) || is_empty_list(k3) ||
        is_empty_list(k4)) {
      FreeAtomic(pps);
      continue;
    }
...
static int tri_rep_g(List *ml, Atom sp, Atom sm, Atom cp, Atom cm, int sp_s,
                     int sm_s, int cp_s, int cm_s, int sn1, int sn2, Atom o1,
                     Atom o2) {
  List l1, k1, k2, k3, k4;
  ...
  for (l1 = *ml; l1; l1 = ListTail(l1)) {
    ...
    for (k4 = *ml; k4; k4 = ListTail(k4)) {
      if (k1 == k4 || k2 == k4 || k3 == k4)
        continue;
      if (EqualTerms(pp, CompoundArg2(ListFirst(k4))) &&
          CompoundArg1(ListFirst(k4)) ==
              NewInteger(-2 * sn1 * nu * sm_s * cm_s))
        break;
    }
...
static int tri_rep_h(List *ml, Atom i1, Atom i2, Atom i3, Atom i4, int s_1,
                     int s_2, int has1, Atom o1, Atom o2, int s_o) {
  List l1, k1, k2, k3 = 0;
...
int tri_rep_cs3(List *ml, Atom s1, Atom s2, Atom c1, Atom c2, Atom sapb,
                Atom samb, Atom capb, Atom camb, int sapbs, int sambs,
                int capbs, int cambs);
...
int tri_opti_2(Term v2d, List *m2l) {
  ...
  tri_rep_cs3(m2l, sa1, sa2, ca1, ca2, sapb, samb, capb, camb, sapb_s, samb_s,
              capb_s, camb_s);
  ...
  do {
    ...
    chs |= tri_rep_g(m2l, sapb, samb, capb, camb, sapb_s, samb_s, capb_s,
                     camb_s, 1, c2a1_s, s2a1, c2a1);
    chs |= tri_rep_g(m2l, sapb, samb, capb, camb, sapb_s, samb_s, capb_s,
                     camb_s, -1, c2a2_s, s2a2, c2a2);

    chs |= tri_rep_h(m2l, sapb, sapb, samb, samb, -1, -1, 1, c2a1, c2a2,
                     c2a1_s * c2a2_s);
    chs |= tri_rep_h(m2l, sapb, sapb, samb, samb, 1, -1, 0, s2a1, s2a2, 1);
    chs |= tri_rep_h(m2l, capb, sapb, camb, samb, capb_s * sapb_s,
                     -camb_s * samb_s, 0, c2a1, s2a2, c2a1_s);
    chs |= tri_rep_h(m2l, capb, sapb, camb, samb, capb_s * sapb_s,
                     camb_s * samb_s, 0, c2a2, s2a1, c2a2_s);

    chs |= tri_rep_e(m2l, capb_s * camb_s, capb, camb, -sapb_s * samb_s, sapb,
                     samb, c2a1);
    chs |= tri_rep_e(m2l, capb_s * camb_s, camb, capb, sapb_s * samb_s, sapb,
                     samb, c2a2);
    chs |= tri_rep_e(m2l, capb_s * samb_s, capb, samb, camb_s * sapb_s, camb,
                     sapb, s2a1);
    chs |= tri_rep_e(m2l, -capb_s * samb_s, capb, samb, camb_s * sapb_s, camb,
                     sapb, s2a2);
