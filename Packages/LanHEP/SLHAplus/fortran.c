...
double cslhaval2_(char *Block, double *Q, int *k1, int *k2, int len) {
  char c_name[200];
  Complex res;
  fName2c(Block, c_name, len);
...
int allblocks_(int *i, int *j, char *name, int *Len, int *key, Complex *val,
               int l) {
  char c_name[40];
...
int cjacobih_(Complex *a, int *n, double *d, Complex *v) {
  return cJacobiH(a, *n, d, v);
}
int cjacobis_(Complex *a, int *n, double *d, Complex *v) {
