...
PyObject *initialize_lilith(char *experimental_input) {
  ...
  PyObject *lilithconstructor =
      PyObject_GetAttrString(lilithModule, (char *)"Lilith");
  ...
  PyObject *lilithsetexpinput =
      PyObject_GetAttrString(lilithcalc, (char *)"readexpinput");
...
PyObject *lilith_readuserinput(PyObject *lilithcalc, char *XMLinputstring) {
  ...
  PyObject *readuserinput =
      PyObject_GetAttrString(lilithcalc, (char *)"readuserinput");
...
**/
PyObject *lilith_readuserinput_fromfile(PyObject *lilithcalc,
                                        char *XMLinputfile) {
  // Getting the function to read the user input
  PyObject *readuserinput =
      PyObject_GetAttrString(lilithcalc, (char *)"readuserinputfile");
  // Passing the user input file to this function
  PyObject *args;
...
float lilith_computelikelihood(PyObject *lilithcalc) {
  ...
  PyObject *computelikelihood =
      PyObject_GetAttrString(lilithcalc, (char *)"computelikelihood");
...
void lilith_couplings_output(PyObject *lilithcalc, char *outputfilepath) {
  ...
  PyObject *writecouplings =
      PyObject_GetAttrString(lilithcalc, (char *)"writecouplings");
...
**/
void lilith_likelihood_output(PyObject *lilithcalc, char *outputfilepath,
                              int slha) {
  if (userread == 0) {
    printf("\nError occured while reading the user input file\n");
    if (slha == 0) {
  ...
  // Getting the output function
  PyObject *writeresults =
      PyObject_GetAttrString(lilithcalc, (char *)"writeresults");
  // Passing the output filepath to this function
  PyObject *args;
  if (slha == 0) {
...
void lilith_mu_output(PyObject *lilithcalc, char *outputfilepath, int tot) {
  ...
  // Getting the output function
  PyObject *writesignalstrengths =
      PyObject_GetAttrString(lilithcalc, (char *)"writesignalstrengths");
  // Passing the output filepath to this function
  PyObject *args;
  if (tot == 0) {
    args = PyTuple_Pack(2, PyString_FromString(outputfilepath), Py_False);
