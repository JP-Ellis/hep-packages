...
int main(int argc, char **argv) {
...
#ifdef SUGRA
  {
    ...
    err = nmssmSUGRA(m0, mhf, a0, tb, sgn, Lambda, aLambda, aKappa, xif, xis,
                     muP, MSPQ, M3HQ);
    printf("err=%d\n", err);
  }
#elif defined(EWSB)
...
#ifdef CDM_NUCLEUS
  {
    ...
    nEvents = nucleusRecoil(Maxwell, 73, Z_Ge, J_Ge73, S00Ge73, S01Ge73,
                            S11Ge73, dNdE);
    ...
    nEvents = nucleusRecoil(Maxwell, 131, Z_Xe, J_Xe131, S00Xe131, S01Xe131,
                            S11Xe131, dNdE);
    ...
    nEvents = nucleusRecoil(Maxwell, 23, Z_Na, J_Na23, S00Na23, S01Na23,
                            S11Na23, dNdE);
    ...
    nEvents = nucleusRecoil(Maxwell, 127, Z_I, J_I127, S00I127, S01I127,
                            S11I127, dNdE);
...
#ifdef CROSS_SECTIONS
  {
    ...
    Helicity[1] =
        -0.5; /* helicities ={ 0.5, -0.5} corresponds to vector state */
    ...
    if (cc) {
      ...
      for (l = 1; l <= ntot; l++) {
        ...
        sprintf(txt, "%3s,%3s -> %3s %3s  ", name[0], name[1], name[2],
                name[3]);
