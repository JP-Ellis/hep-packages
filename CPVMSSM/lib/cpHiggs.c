...
double cpHiggs(double EE, double alfaSMZ, double Mtp, double McMt, double MbMt,
               double Ml, double SW, double tb, double MHc, double aMu,
               double fiMu, double aM1, double fiM1, double aM2, double fiM2,
               double aM3, double fiM3, double Mq3, double Mu3, double Md3,
               double Ml3, double Mr3, double aAt, double fiAt, double aAb,
               double fiAb, double aAl, double fiAl, double aAu, double fiAu,
               double aAd, double fiAd, double aAe, double fiAe, double aAm,
               double fiAm) {
  FILE *f;
  char *command;
  int err;
  ...
  /* new */
  fprintf(f,
          "%E              ! SSPARA(22) = Hierarchy factor between first 2 and "
          "third generations M_Q\n",
          findValW("Mq2") / Mq3);
  fprintf(f,
          "%E              ! SSPARA(23) = Hierarchy factor between first 2 and "
          "third generations M_U\n",
          findValW("Mu2") / Mu3);
  fprintf(f,
          "%E              ! SSPARA(24) = Hierarchy factor between first 2 and "
          "third generations M_D\n",
          findValW("Md2") / Md3);
  fprintf(f,
          "%E              ! SSPARA(25) = Hierarchy factor between first 2 and "
          "third generations M_L\n",
          findValW("Ml2") / Ml3);
  fprintf(f,
          "%E              ! SSPARA(26) = Hierarchy factor between first 2 and "
          "third generations M_E\n",
          findValW("Mr2") / Mr3);
  /*===*/
  ...
  fprintf(f,
          "1                   ! IFLAG_H(3)  if 1, print sfermion sector \n");
  fprintf(f, "1                   ! IFLAG_H(4)  if 1, print -ino sector \n");
  fprintf(f, "0                   ! IFLAG_H(5)  print couplings : 1=H_1 2=H_2 "
             "3=H_3 4=H^pm 5=Higgs "
             "self 6=ALL \n");
  fprintf(f, "5                   ! IFLAG_H(6)  print decay widths and brs : "
             "1=H_1 2=H_2 3=H_3 4=H^pm "
             "5=ALL \n");
  fprintf(f, "0                   ! IFLAG_H(10) if 0, include the threshold "
             "corrections  \n");
  fprintf(f, "0                   ! IFLAG_H(11) use pole mass (0) or eff. pot. "
             "mass (1) \n");
  /* new */

  fprintf(f, "5                   ! IFLAG_H(12) 5 or 0 for full improvement\n");
  fprintf(f, "0                   ! IFLAG_H(13) 1 Not to include the "
             "off-diagonal absorptive parts\n");
  fprintf(f, "1                   ! IFLAG_H(14) 1 to print FILLDHPG results\n");
  /* fprintf(f,"1                   ! IFLAG_H(15) 1 to print HiggsEDM
   * results\n");*/
  fprintf(f, "1                   ! IFLAG_H(16) 1 to print FILLBOBS results\n");
  fprintf(
      f, "1                   ! IFLAG_H(17) 1 to print b -> s gamma details\n");
