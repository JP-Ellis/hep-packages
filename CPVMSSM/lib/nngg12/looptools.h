...
integer ncaches parameter(ncaches = 10)
    ...
    DB001C ComplexType B0000, B0011, B1111, B00001, B00111,
    B11111 ComplexType B0000C, B0011C, B1111C, B00001C, B00111C,
    B11111C ComplexType C0, C0C, C0i, C0iC ComplexType D0, D0C, D0i,
    D0iC ComplexType E0, E0C, E0i, E0iC ComplexType Li2, Li2C, Li2omx,
    Li2omxC memindex Aget, AgetC, Bget, BgetC, Cget, CgetC memindex Dget, DgetC,
    Eget, EgetC RealType getmudim, getdelta, getlambda,
    ...
    DB11, DB001 external DB0C, DB1C, DB00C, DB11C, DB001C external B0000, B0011,
    B1111, B00001, B00111, B11111 external B0000C, B0011C, B1111C, B00001C,
    B00111C, B11111C external C0, C0C, C0i, C0iC external D0, D0C, D0i,
    D0iC external E0, E0C, E0i, E0iC external Li2, Li2C, Li2omx,
    Li2omxC external Aget, AgetC, Bget, BgetC, Cget, CgetC external Dget, DgetC,
    Eget, EgetC external getmudim, getdelta, getlambda,
    getminmass external getmaxdev external getepsi, getwarndigits,
