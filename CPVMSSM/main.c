...
int main(int argc, char **argv) {
...
#ifdef CONSTRAINTS
  {
    ...
    printf("EDM(Mercury)=%.2E",
           slhaValFormat("FDIPOLE", 0., "1000801990  1 1 %lf"));
    printf("  # %s\n", slhaComment);
    //  printf("EDM(electron)=%.2E\n", slhaValFormat("dipoleMOM",0.,"1000812030
    //  1 %lf") ) ;
    ...
    //  slhaValFormat("deltaM",0.,"511 1 %lf")); printf("SUSY mass diff,
...
#include "../include/SMODELS.inc"
...
#ifdef OMEGA
  {
    ...
    VZdecay = 1;
    VWdecay = 1;
    cleanDecayTable(); // restore default
  }
#endif
...
#ifdef SHOWPLOTS
    displaySpectra("neutrino fluxes [1/Year/km^2/GeV]", Emin, Mcdm, 2, nu, "nu",
                   nu_bar, "nu_bar");
#endif
...
#ifdef SHOWPLOTS
    displayPlot("Upward muons[1/Year/km^2/GeV]", "E[GeV]", 1, Mcdm / 2, 0, 1,
                "flux", 0, SpectdNdE, mu);
#endif
