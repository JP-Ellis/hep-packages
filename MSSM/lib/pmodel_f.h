...
/*=============================================
  ...
  =============================================*/
extern int suspectsugra_(double *tb, double *MG1, double *MG2, double *MG3,
                         double *Al, double *At, double *Ab, double *sgn,
                         double *MHu, double *MHd, double *Ml1, double *Ml3,
...
extern int isajetsugra_(double *tb, double *MG1, double *MG2, double *MG3,
                        double *Al, double *At, double *Ab, double *sgn,
                        double *MHu, double *MHd, double *Ml1, double *Ml3,
                        double *Mr1, double *Mr3, double *Mq1, double *Mq3,
                        double *Mu1, double *Mu3, double *Md1, double *Md3);
...
extern int softsusysugra_(double *tb, double *MG1, double *MG2, double *MG3,
                          double *Al, double *At, double *Ab, double *sgn,
                          double *MHu, double *MHd, double *Ml1, double *Ml3,
                          double *Mr1, double *Mr3, double *Mq1, double *Mq3,
                          double *Mu1, double *Mu3, double *Md1, double *Md3);
...
extern int sphenosugra_(double *tb, double *MG1, double *MG2, double *MG3,
                        double *Al, double *At, double *Ab, double *sgn,
                        double *MHu, double *MHd, double *Ml1, double *Ml3,
                        double *Mr1, double *Mr3, double *Mq1, double *Mq3,
                        double *Mu1, double *Mu3, double *Md1, double *Md3);
...
extern int softsusyamsb_(double *am0, double *m32, double *stgbeta,
                         double *sgn);
/*
