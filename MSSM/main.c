...
#include "../include/SMODELS.inc"
...
#ifdef CDM_NUCLEUS
  {
...
#ifdef SHOWPLOTS
    displayPlot("Distribution of recoil energy of 73Ge", "E[KeV]", 1, 50, 0, 1,
    ...
    printf("Number of events in 10 - 50 KeV region=%.2E /day/kg\n",
           cutRecoilResult(dNdE, 10, 50));
#ifdef SHOWPLOTS
    displayPlot("Distribution of recoil energy of 131Xe", "E[KeV]", 1, 50, 0, 1,
                "dN/dE", 0, dNdERecoil, dNdE);
#endif
    ...
    printf("Number of events in 10 - 50 KeV region=%.2E /day/kg\n",
           cutRecoilResult(dNdE, 10, 50));
#ifdef SHOWPLOTS
    displayPlot("Distribution of recoil energy of 23Na", "E[KeV]", 1, 50, 0, 1,
                "dN/dE", 0, dNdERecoil, dNdE);
#endif
    ...
    printf("Number of events in 10 - 50 KeV region=%.2E /day/kg\n",
           cutRecoilResult(dNdE, 10, 50));
#ifdef SHOWPLOTS
    displayPlot("Distribution of recoil energy of 127I", "E[KeV]", 1, 50, 0, 1,
                "dN/dE", 0, dNdERecoil, dNdE);
#endif
  }
#endif
