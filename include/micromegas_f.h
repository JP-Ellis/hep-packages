...
extern void procinfo2_(int *address, int *nsub, char *names, double *masses,
                       int len);
/*
...
extern double printchannels_(double *Xf, double *cut, double *Beps, int *prcnt,
                             int *N);
/*
...
=================================================*/
extern double calcspectrum_(int *key, double *Sg, double *Se, double *Sp,
                            double *Sne, double *Snu, double *Snl, int *err,
                            int len);
/*
...
extern int displayspectrum_(char *fmess, double *Emin, double *Emax,
                            double *tab, int len);
...
extern void calcscalarff_(double *muDmd, double *msDmd, double *sigmaPiN,
                          double *sigma0);
/*
...
extern void calcscalarquarkff_(double *muDmd, double *msDmd, double *sigmaPiN,
                               double *sigmaS);
/*
...
extern int nucleonamplitudes_(char *cdm, double *pA0, double *pA5, double *nA0,
                              double *nA5, int len);
/*
...
extern double nucleusrecoil_(double (*fDv)(double *), int *A, int *Z, double *J,
                             void (*S00)(double *, double *, double *,
                                         double *),
                             double *dNdE);
/*
...
extern double nucleusrecoil0_(
    double (*fDv)(double *), int *A, int *Z, double *J, double *Sp, double *Sn,
...
extern int displayrecoilplot_(double *tab, char *text, double *E1, double *E2,
                              int len);
/*
...
extern Sxx_type sxxf19_, sxxna23_, sxxal27_, sxxsi29_, sxxK39_, sxxge73_,
    sxxnb93_, sxxte125_, sxxi127_, sxxxe129_, sxxxe131_, sxxpb207_, sxxna23a_,
    sxxsi29a_, sxxte125a_, sxxi127a_, sxxxe129a_, sxxxe131a_, sxxge73a_,
    sxxxe131b_;
