...
extern double IC22BGdCos(
    double cs); // background  distribution for cos(Sun,neutrino)
                // based on DS/shared/DarkSusy/IC_data/BG_distributions_IC22.dat
extern double
IC22sigma(double E); // angle(degree) resolution as a function of energy
                     //  based on DS/shared/DarkSusy/IC_data/nuEffArea_IC22.dat
...
extern int IC22histRead(
    void); // reads file data_nu/ic22hist.dat to fill 21 elements of IC22nChan.
           // zero^th one corresponds to background. Next 20 present  channel
           // distribution for different energy regions.
