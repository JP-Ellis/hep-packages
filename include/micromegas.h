...
extern double cs22(numout *cc, int nsub, double P, double cos1, double cos2,
                   int *err);
...
extern double hCollider(double Pcm, int pp, int nf, double Qren, double Qfact,
...
extern double darkOmegaExt(double *Xf, double (*f0)(double),
                           double (*f1)(double));
...
extern double printChannels(double Xf, double cut, double Beps, int prcnt,
                            FILE *f);
extern double oneChannel(double Xf, double Beps, char *n1, char *n2, char *n3,
                         char *n4);
...
// Freeze-in
extern double darkOmegaFi22(double TR, char *Proc, int vegas, int plot,
                            int *err);
extern double decayAbundance(double TR, double M, double w, int Ndf, double eta,
                             int plot);
...
extern double calcSpectrum(int key, double *Sg, double *Se, double *Sp,
                           double *Sne, double *Snu, double *Snl, int *errcode);
/* input parameters:
...
extern void gammaFluxTab(double fi, double dfi, double sigmaV, double *Sp,
                         double *Sobs);
extern double gammaFlux(double fi, double dfi, double dSigmadE);

extern void gammaFluxTabGC(double l, double b, double dl, double db,
                           double sigmaV, double *Sp, double *Sobs);
extern double gammaFluxGC(double l, double b, double dl, double db,
                          double dSigmadE);

extern void solarModulation(double PHI, double mass, double *inTab,
                            double *outTab);
...
extern void posiFluxTab(double Emin, double sigmav, double *iSpect,
                        double *outSpect);

extern void pbarFluxTab(double Emin, double sigmav, double *iSpect,
                        double *outSpect);
...
extern void ATMnuBackgroundTab(double Fi, double dFi, double *nuTab,
                               double *nuBarTab);
extern int neutrinoFlux(double (*vfv)(double), int forSun, double *nu,
                        double *nu_bar);
extern int basicNuSpectra(int forSun, double Mass, int pdgN, int pol,
                          double *nu, double *nuB);
...
extern double captureAux(double (*vfv)(double), int forSun, double M_cdm,
                         double csIp, double csIn, double csDp, double csDn);
...
extern void calcScalarFF(double muDmd, double msDmd, double sigmaPiN,
                         double sigma0);
extern void calcScalarQuarkFF(double muDmd, double msDmd, double sigmaPiN,
                              double sigmaS);
extern int nucleonAmplitudes(char *WINP, double *pA0, double *pA5, double *nA0,
                             double *nA5);
...
extern double nucleusRecoil0(double (*vfv)(double), int A, int Z, double J,
                             double Sp, double Sn, double *dNdE);

extern double nucleusRecoilAux(double (*vfv)(double), int A, int Z, double J,
                               void (*Sxx)(double, double *, double *,
                                           double *),
                               double cs_SI_P, double cs_SI_N, double cs_SD_P,
                               double cs_SD_N, double *dNdE);

extern double nucleusRecoil0Aux(double (*vfv)(double), int A, int Z, double J,
                                double Sp, double Sn, double cs_SI_P,
...
extern SxxType SxxF19, SxxNa23, SxxAl27, SxxSi29, SxxK39, SxxGe73, SxxNb93,
    SxxTe125, SxxI127, SxxXe129, SxxXe129M, SxxXe131, SxxPb207, SxxNa23A,
    SxxSi29A, SxxTe125A, SxxI127A, SxxXe129A, SxxXe131A, SxxXe131Me, SxxGe73A,
    SxxXe131B;
...
extern int Plot3SS(double xiP, double xiN, double (*S00)(double),
                   double (*S01)(double), double (*S11)(double), int A,
                   double J, char *title, double Emax);
extern int Plot3SS0(double xiP, double xiN, double Sp, double Sn, int A,
                    double J, char *title, double Emax);
