...
{TuplesWithMultiplicity, TallyWithMultiplicity, PermutationSymmetryOfTensorProductPartsAuxiliar, PermutationSymmetryOfTensorProductParts, PermutationSymmetryOfInvariants,DistinguishFields,HookContentFormula};
...
(* Options *)
{UseName,SortResult,TensorForm,NormalizeAndSymmetrize,FactorGroupExtraConjugation};

(* Global variables *)
{Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries};
...
Options[SymmetrizeInvariants]={DistinguishFields->False};
...
If[invariantsTensors==={},Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries={};Return[{}]];
...
(* Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries is a global variable which will save the permutation symmetry of the last Invariants calculation *)
Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries=symmetries;
...
aux=Flatten[MapThread[ConstantArray[#1,#2]&,{Times@@@Map[SnIrrepDim,Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries[[2,All,1]],{2}],Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries[[2,All,2]]}]];
...
,{i,Length[Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries[[2]]]}];
...
Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries = Null;
...
tensors=SymmetrizeInvariants[groupOriginal,rOriginal,tensors,cjs,DistinguishFields->distFieds];
...
If[tensors=!={}&&OptionValue[NormalizeAndSymmetrize],
Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries[[1]]=Susyno\[UnderBracket]Invariants\[UnderBracket]Symmetries[[1]]/.MapThread[Rule,{Range[Length[rOriginalIn]],orderingReps}];
];
...
PermutationSymmetryOfTensorProductParts[groupIn_,listOfRepsIn_,OptionsPattern[]]:=Module[{group,sumCharges,listOfReps,aux1,aux2,aux3,plesthysmFields},
...
PermutationSymmetryOfInvariants[group_,listOfReps_,OptionsPattern[]]:=Module[{indices,invariants},
{indices,invariants}=PermutationSymmetryOfTensorProductParts[group,listOfReps,DistinguishFields->OptionValue[DistinguishFields]];
