...
extern double usrFF_(int n_in, int n_out, double *pvect, char **pnames,
                     int *pdg);
extern double usrfun_(char *name, int n_in, int n_out, double *pvect,
                      char **pnames, int *pdg);
extern double usrFF(int n_in, int n_out, double *pvect, char **pnames,
                    int *pdg);
extern double usrfun(char *name, int n_in, int n_out, double *pvect,
                     char **pnames, int *pdg);
...
extern void initpdfm(int *P, int *nSet, double *xMin, double *xMax,
