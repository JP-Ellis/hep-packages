...
double x_grid[NX] = {
    1.0000E-09, 1.4508E-09, 2.1049E-09, 3.0539E-09, 4.4306E-09, 6.4281E-09,
    9.3260E-09, 1.3530E-08, 1.9630E-08, 2.8480E-08, 4.1320E-08, 5.9948E-08,
    8.6975E-08, 1.2619E-07, 1.8307E-07, 2.6561E-07, 3.8535E-07, 5.5908E-07,
    8.1113E-07, 1.1768E-06, 1.7074E-06, 2.4771E-06, 3.5938E-06, 5.2140E-06,
    7.5646E-06, 1.0975E-05, 1.5923E-05, 2.3101E-05, 3.3516E-05, 4.8626E-05,
    7.0548E-05, 1.0235E-04, 1.4850E-04, 2.1544E-04, 3.1257E-04, 4.5349E-04,
    6.5793E-04, 9.5455E-04, 1.3849E-03, 2.0092E-03, 2.9151E-03, 4.2292E-03,
    6.1359E-03, 8.9022E-03, 1.2915E-02, 1.8738E-02, 2.7186E-02, 3.9442E-02,
    5.7224E-02, 8.3022E-02, 1.0000E-01, 1.1837E-01, 1.3673E-01, 1.5510E-01,
    1.7347E-01, 1.9184E-01, 2.1020E-01, 2.2857E-01, 2.4694E-01, 2.6531E-01,
    2.8367E-01, 3.0204E-01, 3.2041E-01, 3.3878E-01, 3.5714E-01, 3.7551E-01,
    3.9388E-01, 4.1224E-01, 4.3061E-01, 4.4898E-01, 4.6735E-01, 4.8571E-01,
    5.0408E-01, 5.2245E-01, 5.4082E-01, 5.5918E-01, 5.7755E-01, 5.9592E-01,
    6.1429E-01, 6.3265E-01, 6.5102E-01, 6.6939E-01, 6.8776E-01, 7.0612E-01,
    7.2449E-01, 7.4286E-01, 7.6122E-01, 7.7959E-01, 7.9796E-01, 8.1633E-01,
    8.3469E-01, 8.5306E-01, 8.7143E-01, 8.8980E-01, 9.0816E-01, 9.2653E-01,
    9.4490E-01, 9.6327E-01, 9.8163E-01, 1.0000E+00};
...
int main(int argc, char **argv) {
  ...
  if (mem == 0)
    strcpy(pdf_name_, pdf_name);
  else
    sprintf(pdf_name_, "%s:%d", pdf_name, mem);
  ...
  for (i = 0; i < NP; i++)
    if (abs(pdg[i]) >= 3 && abs(pdg[i]) <= 6)
      fprintf(f, " (%d %d) ", abs(pdg[i]), -abs(pdg[i]));
    else
      fprintf(f, " %d ", pdg[i]);
  fprintf(f, "\n");
  ...
  fprintf(f, "#Q_grid\n");
  for (i = 0; i < NQ; i++) {
    fprintf(f, " %.4E", q_grid[i]);
    if ((i + 1) % 10 == 0)
      fprintf(f, "\n");
  }
  fprintf(f, "\n#X_grid\n");
  for (i = 0; i < NX; i++) {
    fprintf(f, " %.4E", x_grid[i]);
    if ((i + 1) % 10 == 0)
      fprintf(f, "\n");
  }
  ...
  fprintf(f, "\n#Alpha\n");
  for (i = 0; i < NQ; i++) {
    fprintf(f, " %.4E", alphaspdfm_(&P, q_grid + i));
    if ((i + 1) % 10 == 0)
      fprintf(f, "\n");
  }
