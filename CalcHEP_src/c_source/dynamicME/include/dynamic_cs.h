...
extern double (*sqme)(int nsub, double GG, REAL *pvect, REAL *cb_coeff,
                      int *err_code);
...
extern numout *xVtoxll(int Nin, int Nout, char **name, int *pdg, int lV,
                       double *wV, double *br);
...
#ifndef __cplusplus
extern int HiggsLambdas(double Q, char *Higgs, double complex *lGG,
                        double complex *lGG5, double complex *lAA,
                        double complex *lAA5);
