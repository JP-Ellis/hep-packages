...
extern int FError;
extern int slhaBasicReader(int mode, int (*readLn)(int, char *), int *anydate,
                           char *end);
...
extern int findQnumbers(int pdg, int *eQ3, int *spinDim, int *cDim,
                        int *neutral);
extern int allQnumbers(int i, int *pdg, int *eQ3, int *spinDim, int *cDim,
                       int *neutral);
#ifndef __cplusplus
extern int allBlocks(int i, int j, char *name, int *Len, int *key,
                     double complex *val);
#endif
extern int allDecays(int i, int j, int *pdg, int *Len, int *decay,
                     double *width, double *br);
...
extern int aPrintF5(char *format, double x1, double x2, double x3, double x4,
                    double x5);
extern int aPrintF6(char *format, double x1, double x2, double x3, double x4,
                    double x5, double x6);
extern int aPrintF7(char *format, double x1, double x2, double x3, double x4,
                    double x5, double x6, double x7);
extern int aPrintF8(char *format, double x1, double x2, double x3, double x4,
                    double x5, double x6, double x7, double x8);
extern int aPrintF9(char *format, double x1, double x2, double x3, double x4,
