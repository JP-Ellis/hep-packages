...
extern void sg_drawLine(int x1, int y1, int x2, int y2, int color,
...
enum line_styles { SolidLn = 0, DottedLn = 1, DashedLn = 3 };

enum line_widths { NormWidth = 1, ThickWidth = 3 };
