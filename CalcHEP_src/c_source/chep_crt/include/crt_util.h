...
extern void menu0(int col, int row, char *label, char *filename,
                  void (**funcKey)(int i), char **funcKeyMess, void **hscr,
                  int *kk);
...
extern int correctStr(int x, int y, char *txt, char *var, int maxLen,
                      int clear);

extern void menu1(int col, int row, char *name, char *menustr, char *help,
                  void *hscr, int *kk);
