  ...
  ypedef struct csdiagram
     {
        ...
        int           mult;
        unsigned          del;
        char          status;   // -2-outOfMemory,-1-deleted, 0-Rest,
  1-calculated,2-Zero int nsub; }  csdiagram;
  */
  {
