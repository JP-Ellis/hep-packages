...
extern void wrt_menu(int menutype, int k, char *txt, int ndel, int ncalc,
                     int nrest, long recpos);
extern int rd_menu(int menutype, int k, char *txt, int *ndel, int *ncalc,
                   int *nrest, long *recpos);
