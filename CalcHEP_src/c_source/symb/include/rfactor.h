...
extern void sew_vm(vmptr *p1, vmptr p2, int mlt);

extern void reduce_s(s_monom *s1, s_monom *s2);

extern void mult_s(s_monom *s1, s_monom *s2);

extern void mult_rptr(rmptr *m1, rmptr *m2);

extern char *smonomtxt(s_monom s);

extern char *rmonomtxt(r_monom r);

extern void copysmonom(s_monom src, s_monom *dst);

extern void diagramsrfactors(hlpcsptr gst, s_listptr *s, rmptr *totf);
